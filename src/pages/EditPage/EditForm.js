      ...
      <div>
        ...
        >
          <MDBRow className="title-col-container">
            <MDBCol md="4">
              <label htmlFor="defaultFormRegistertitle" className="grey-text">
                Movie title :
              </label>
              <input
          ...
          <div className="container-row">
            <MDBRow>
              <MDBCol md="4">
                <label htmlFor="defaultFormRegistergenre" className="grey-text">
                  Genre :
                </label>
                <input
              ...
              <MDBCol md="4">
                <label htmlFor="defaultFormRegisteryear" className="grey-text">
                  Year :
                </label>
                <input
          ...
          <div className="edit-button-container">
            <MDBBtn
              ...
              onClick={this.handleFetchOnClick}
            >
              Edit movie
            </MDBBtn>
          </div>
