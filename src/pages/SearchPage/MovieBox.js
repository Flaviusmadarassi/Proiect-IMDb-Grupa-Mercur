...
class MovieBox extends Component {
  render() {
    return (
      <div className="content-container-movies">
        <p className="movie-title">{this.props.movie_details.Title}</p>
        <img
          className="image-container-movies"
          src={this.props.movie_details.Poster}
        ></img>
        <p className="movie-genre">
          <span className="genre-header">Genre: </span>
          {this.props.movie_details.Genre}
        </p>
        ...
        <p className="movie-raiting-number">
        ...
        <div className="containerButtonMovieDetails">
          <Link to={"/movie-details?id=" + this.props.movie_details._id}>
            <button className="buttonMovieDetails">View Details</button>
          </Link>
        </div>
      </div>
    );
